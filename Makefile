...
server: $(OBJ_LOGIC)/socket.o $(OBJ_LOGIC)/netio.o $(OBJ_L1)/sockettimes.o $(OBJ_L1)/mainsocket.o $(OBJ_L1)/commandfunctions.o $(OBJ_L1)/prdtime.o $(OBJ_L1)/prdfunction.o $(OBJ_L1)/inputpayload.o $(OBJ_L1)/inputcommand.o $(OBJ_L2)/sockettime.o $(OBJ_L2)/readlist.o $(OBJ_L2)/socketlist.o $(OBJ_L2)/socket.o $(OBJ_L2)/command.o $(OBJ_L2)/periodic.o $(OBJ_L2)/inputparser.o $(OBJ)/server.o $(OBJ)/main.o | $(BIN)
	$(CC) $(CFLAGS) -o $(BIN)/$@ $^
